...
public class FileActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        if (file.isDirectory()) {
            ...
            if (file.getName().endsWith(".txt") || file.getName().endsWith(".log")){
                Toast.makeText(this, "我点击了txt文件", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(this,TextActivity.class);
                intent.putExtra("lujing",file.getPath());
                startActivity(intent);

            }
            
//            Toast.makeText(this, "打开" + file.getName(),
    ...
    private void addDirText(File file) {
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d(TAG, "F onClick: " + ll_root.getChildCount());
